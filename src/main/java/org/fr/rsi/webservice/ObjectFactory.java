 ...
 * generated in the org.fr.rsi package. 
...
public class ObjectFactory {
    ...
    private final static QName _Echo_QNAME = new QName("http://rsi.fr.org/", "echo");
    private final static QName _EchoResponse_QNAME = new QName("http://rsi.fr.org/", "echoResponse");
    private final static QName _DownloadImage_QNAME = new QName("http://rsi.fr.org/", "downloadImage");
    private final static QName _DownloadImageResponse_QNAME = new QName("http://rsi.fr.org/", "downloadImageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.fr.rsi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.fr.org/", name = "echo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.fr.org/", name = "echoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.fr.org/", name = "downloadImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rsi.fr.org/", name = "downloadImageResponse")
